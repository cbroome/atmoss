...
import type { XrpcResponse, XrpcResponseBody, XrpcResponseOptions } from './response.js';
 ...
 */
export type CreateRecordOptions = Omit<XrpcOptions<typeof createRecord>, 'body'> & {
 ...
 */
export type DeleteRecordOptions = Omit<XrpcOptions<typeof deleteRecord>, 'body'> & {
    /** Repository identifier (DID or handle). Defaults to authenticated user's DID. */
    repo?: AtIdentifierString;
    /** Compare-and-swap on the repo commit. If specified, must match current commit. */
    swapCommit?: string;
 ...
 */
export type ListRecordsOptions = Omit<XrpcOptions<typeof listRecords>, 'params'> & {
    /** Repository identifier (DID or handle). Defaults to authenticated user's DID. */
    repo?: AtIdentifierString;
 ...
 */
export type ApplyWritesOptions = Omit<XrpcOptions<typeof applyWrites>, 'body'> & {
    /** Repository identifier (DID or handle). Defaults to authenticated user's DID. */
    repo?: AtIdentifierString;
    /**
 ...
 */
export type CreateOutput = InferMethodOutputBody<typeof createRecord, Uint8Array>;
/**
 ...
 */
export type DeleteOutput = InferMethodOutputBody<typeof deleteRecord, Uint8Array>;
/**
 ...
 * @typeParam T - The record schema type
 */
export type GetOutput<T extends RecordSchema> = Omit<InferMethodOutputBody<typeof getRecord, Uint8Array>, 'value'> & {
    value: Infer<T>;
};
/**
...
export declare class Client implements Agent {
    ...
    createRecord(record: TypedLexMap<NsidString>, rkey?: string, options?: CreateRecordOptions): Promise<XrpcResponse<Procedure<"com.atproto.repo.createRecord", import("@atproto/lex-schema").ParamsSchema<{}>, import("@atproto/lex-schema").Payload<"application/json", import("@atproto/lex-schema").ObjectSchema<{
        ...
        commit: import("@atproto/lex-schema").OptionalSchema<import("@atproto/lex-schema").RefSchema<import("@atproto/lex-schema").Validator<import("./lexicons/com/atproto/repo/defs.defs.js").CommitMeta, import("./lexicons/com/atproto/repo/defs.defs.js").CommitMeta>>>;
     ...
     * ```
     */
    applyWrites(factory: WriteOperationsFactory, options?: ApplyWritesOptions): Promise<XrpcResponse<Procedure<"com.atproto.repo.applyWrites", import("@atproto/lex-schema").ParamsSchema<{}>, import("@atproto/lex-schema").Payload<"application/json", import("@atproto/lex-schema").ObjectSchema<{
        repo: import("@atproto/lex-schema").StringSchema<{
            readonly format: "at-identifier";
        }>;
        validate: import("@atproto/lex-schema").OptionalSchema<import("@atproto/lex-schema").BooleanSchema>;
        writes: import("@atproto/lex-schema").ArraySchema<import("@atproto/lex-schema").TypedUnionSchema<readonly [import("@atproto/lex-schema").TypedRefSchema<import("@atproto/lex-schema").TypedObjectValidator<import("./lexicons/com/atproto/repo/applyWrites.defs.js").Create, import("./lexicons/com/atproto/repo/applyWrites.defs.js").Create>>, import("@atproto/lex-schema").TypedRefSchema<import("@atproto/lex-schema").TypedObjectValidator<import("./lexicons/com/atproto/repo/applyWrites.defs.js").Update, import("./lexicons/com/atproto/repo/applyWrites.defs.js").Update>>, import("@atproto/lex-schema").TypedRefSchema<import("@atproto/lex-schema").TypedObjectValidator<import("./lexicons/com/atproto/repo/applyWrites.defs.js").Delete, import("./lexicons/com/atproto/repo/applyWrites.defs.js").Delete>>], true>>;
        swapCommit: import("@atproto/lex-schema").OptionalSchema<import("@atproto/lex-schema").StringSchema<{
            readonly format: "cid";
        }>>;
    }>>, import("@atproto/lex-schema").Payload<"application/json", import("@atproto/lex-schema").ObjectSchema<{
        commit: import("@atproto/lex-schema").OptionalSchema<import("@atproto/lex-schema").RefSchema<import("@atproto/lex-schema").Validator<import("./lexicons/com/atproto/repo/defs.defs.js").CommitMeta, import("./lexicons/com/atproto/repo/defs.defs.js").CommitMeta>>>;
        results: import("@atproto/lex-schema").OptionalSchema<import("@atproto/lex-schema").ArraySchema<import("@atproto/lex-schema").TypedUnionSchema<readonly [import("@atproto/lex-schema").TypedRefSchema<import("@atproto/lex-schema").TypedObjectValidator<import("./lexicons/com/atproto/repo/applyWrites.defs.js").CreateResult, import("./lexicons/com/atproto/repo/applyWrites.defs.js").CreateResult>>, import("@atproto/lex-schema").TypedRefSchema<import("@atproto/lex-schema").TypedObjectValidator<import("./lexicons/com/atproto/repo/applyWrites.defs.js").UpdateResult, import("./lexicons/com/atproto/repo/applyWrites.defs.js").UpdateResult>>, import("@atproto/lex-schema").TypedRefSchema<import("@atproto/lex-schema").TypedObjectValidator<import("./lexicons/com/atproto/repo/applyWrites.defs.js").DeleteResult, import("./lexicons/com/atproto/repo/applyWrites.defs.js").DeleteResult>>], true>>>;
    }>>, readonly ["InvalidSwap"]>>>;
    /**
     ...
     */
    listAll<const T extends RecordSchema>(ns: Main<T>, { maxRetries, ...options }?: ListOptions): AsyncGenerator<ListRecordItem<Infer<T>>, void, unknown>;
}
