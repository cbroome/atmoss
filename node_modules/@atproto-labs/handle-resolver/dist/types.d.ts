 ...
 * end users.
 */
export type HandleResolverErrorHandler = (err: unknown, context: HandleResolverErrorContext) => void;
 ...
 * @see {@link https://atproto.com/specs/did#blessed-did-methods}
 */
export declare function isResolvedHandle(value: unknown): value is ResolvedHandle;
export declare function asResolvedHandle<T>(value: T): null | (T & AtprotoDid);
